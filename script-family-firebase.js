    ...
    try {
        ...
        db.ref('familyWeatherSettings').on('value', (snapshot) => {
            ...
            if (data) {
                ...
                localStorage.setItem('familyWeatherSettings', JSON.stringify(weatherSettings));
...
function displaySkiDays() {
    ...
    if (currentDays.length === 0) {
        daysList.innerHTML = `<p style="text-align: center; color: #1B5E20; padding: 20px;">No ski days recorded yet for ${getDisplayName(currentUser)}.</p>`;
        return;
    }
        ...
        <div class="extreme-stats">
            ...
            ${coldestDay ? `
                <div class="extreme-item">
                    ...
                    <p class="extreme-user">${getDisplayName(coldestDay.user)} on ${(() => {
            ...
            ${deepestPowder ? `
                <div class="extreme-item">
                    ...
                    <p class="extreme-user">${getDisplayName(deepestPowder.user)} on ${(() => {
...
// Goals System
let userGoals = JSON.parse(localStorage.getItem('familySkiGoals')) || {};
...
window.addGoal = function() {
    ...
    localStorage.setItem('familySkiGoals', JSON.stringify(userGoals));
    loadGoalsAndBadges();
}
